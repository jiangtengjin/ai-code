...
import com.xhh.aicode.innerservice.InnerScreenshotService;
...
import com.xhh.aicode.monitor.MonitorContext;
import com.xhh.aicode.monitor.MonitorContextHolder;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 7. 调用 AI 生成代码（流式），并在完成或错误时持久化 AI 消息或错误信息
