package com.xhh.aicode.langgraph4j.node;

import com.xhh.aicode.langgraph4j.ai.ImageCollectionPlanService;
...
import com.xhh.aicode.langgraph4j.tools.ImageSearchTool;
import com.xhh.aicode.langgraph4j.tools.LogoGeneratorTool;
import com.xhh.aicode.langgraph4j.tools.MermaidDiagramTool;
import com.xhh.aicode.langgraph4j.tools.UndrawIllustrationTool;
...
public class ImageCollectorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            // 停止计时
            stopWatch.stop();
            log.info("图片收集耗时: {} ms", stopWatch.getTotalTimeMillis());
